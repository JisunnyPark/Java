...
// java에서 선언해둔 웹소켓 접속 URL 뒤에 요청명을 덧붙여 웹소켓 객체를 생성, CHAT_ADDR은 web.xml에서 설정
...
webSocket.onmessage = function(event) {
	...
	if(content != "") {
		if(content.match("/")) { // 귓속말
			if (content.match(("/" + chatId))) { // 나에게만 보낸 메시지만 출력
	...
	chatWindow.scrollTop = chatWindow.scrollHeight; // 스크롤바 항상 아래로 내림
}
</script>
